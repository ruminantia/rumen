...
class OutputHandler:
    ...
    def save_result(
        ...
        file_path = self.settings.output_directory / filename
    ...
    def list_results(self, limit: Optional[int] = None) -> list[Path]:
        """
        ...
        """
        try:
            files = list(self.settings.output_directory.glob("*"))
    ...
    def cleanup_old_results(self, max_age_days: int = 30):
        ...
        try:
            ...
            for file_path in self.settings.output_directory.glob("*"):
